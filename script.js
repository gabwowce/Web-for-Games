const cardsArray = [
    ...
    { name: 'Papaya', img: 'img/papaya.png' },
    { name: 'Soursop', img: 'img/soursop.png' },
    { name: 'Coconut', img: 'img/coconut.png' },
    { name: 'Kumquat', img: 'img/kumquat.png' },
    { name: 'Bactris-gasipaes', img: 'img/bactris-gasipaes.png' },
    ...
    { name: 'Bactris-gasipaes', img: 'img/bactris-gasipaes.png' },
    { name: 'Banana', img: 'img/banana.png' },
    { name: 'Dragon-fruit', img: 'img/dragon-fruit.png' },
    { name: 'Dragon-fruit', img: 'img/dragon-fruit.png' }
];
